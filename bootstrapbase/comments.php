 ...
 */
$fields =  array(
	'author' => '<div class="comment-form-left"><p class="comment-form-author">' . '<label for="author">' . __( 'Name', 'domainreference' ) . '</label> ' . ( $req ? '<span class="required">*</span>' : '' ) .
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <ol class="commentlist">
            <?php
                 ...
                 */
                wp_list_comments( array( 'callback' => 'bsb_shape_comment' ) );
            ?>
        </ol><!-- .commentlist -->
